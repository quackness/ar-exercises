...
# a store_id (integer) column. This is a column that identifies 
...
# Create them through the @store# instance variables that you defined 
...
@store2.employees.create(first_name: "Grzegorz", last_name: "Dubaj", hourly_rate: 90)
